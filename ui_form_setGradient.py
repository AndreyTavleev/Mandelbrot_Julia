...
class Ui_setGradient(object):
    def setupUi(self, setGradient):
        ...
        self.gridLayout.addWidget(self.label, 0, 0, 1, 3, Qt.AlignmentFlag.AlignHCenter)

        self.GradWidget = QWidget(setGradient)
        self.GradWidget.setObjectName(u"GradWidget")

        self.gridLayout.addWidget(self.GradWidget, 1, 0, 1, 3)
        ...
        self.gridLayout.addWidget(self.pushButton_Load, 3, 1, 1, 1, Qt.AlignmentFlag.AlignHCenter)

        self.pushButton_Save = QPushButton(setGradient)
        self.pushButton_Save.setObjectName(u"pushButton_Save")

        self.gridLayout.addWidget(self.pushButton_Save, 3, 2, 1, 1, Qt.AlignmentFlag.AlignLeft)
